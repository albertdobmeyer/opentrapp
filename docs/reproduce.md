...
| Field | Value |
|-------|-------|
| Claim | A 115-check manifest-orchestration suite runs on every commit and reports zero warnings in the released configuration |
...
| Expected output | Last line: `Results: 115 passed, 0 failed, 0 warnings (total: 115 checks)` |
| Runtime | ≤ 30 s |
...
| Field | Value |
|-------|-------|
| Claim | The 115-check orchestrator suite reports zero warnings |
...
| Expected output | `Results: 115 passed, 0 failed, 0 warnings (total: 115 checks)` |
| Runtime | ≤ 30 s |
