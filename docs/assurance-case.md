...
This decomposes into five sub-claims (C1 to C5). Each lists its argument and evidence,
...
- [`threat-model.md`](threat-model.md): attacker categories T1 to T6 with the gaps
